...
sshpass -p $SSH_PASSWORD ssh $SSH_USER@$CLUSTER_NAME-ssh.azurehdinsight.net "bash -s" $CLUSTER_NAME $AMBARI_USER $AMBARI_PASSWORD $IS_ESP $SSH_USER <./prep-and-run.sh
