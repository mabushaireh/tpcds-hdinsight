set hive.tez.java.opts=-Xmx256000m; -- 0.8 * hive.tez.container.size
set hive.tez.container.size=32000;
set tez.runtime.io.sort.mb=12800; -- 0.4 * hive.tez.container.size
set tez.runtime.unordered.output.buffer.size-mb=3200;  -- 0.1 of hive.tex.container.size
